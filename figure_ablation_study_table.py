...
def single_model(data, client_output, is_private, epsilon=1.0):
    ...
    return get_avg_score_single_model(data_name=data, num_repeats=5, num_devices=20, p=0.5, A_t=1.0, client_output=client_output, is_private=is_private, epsilon=epsilon, channel_snr=10)
...
if __name__ == "__main__":
    ...
    items_weakprivate = {
        ...
        r"OTA Majority Voting ($\epsilon=10$)": {
        ...
        r"OTA Belief Summation ($\epsilon=10$)": {
